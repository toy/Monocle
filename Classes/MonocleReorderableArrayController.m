...
- (BOOL)tableView:(NSTableView *)aTableView
  ...
  [pboard setPropertyList:[trf reverseTransformedValue:rowIndexes]
                  forType:MonocleReorderableArrayControllerDragTypeName];
...
- (BOOL)tableView:(NSTableView *)tv
  ...
  if ([[[info draggingPasteboard] types] containsObject:MonocleReorderableArrayControllerDragTypeName]) {
    ...
    NSIndexSet *indexSet = [trf
      transformedValue:[[info draggingPasteboard] propertyListForType:MonocleReorderableArrayControllerDragTypeName]];
