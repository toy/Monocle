...
{	
	...
	removeButtonRect.origin = NSMakePoint(NSMaxX(cellFrame) - demultipliedSize.width - 4, (NSMidY(cellFrame) - (demultipliedSize.height/2)));
...
//	if (!isRecording) return NSZeroRect;
	...
	snapbackRect.origin = NSMakePoint(NSMaxX(cellFrame) - demultipliedSize.width - 2, (NSMaxY(cellFrame) - demultipliedSize.height)/2 + 1);
